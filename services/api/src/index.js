...
if(req.method==='GET'&&url.pathname==='/api/v1')return json(res,200,{name:'ENJAZ API',version:'0.8.0',storage:'postgresql',auth:'supabase',runtime:'enabled',integrations:'enabled',onboarding:'enabled',status:'ready'},origin,context.id);
