...
async function callOpenRouter({ messages, model }) {
  ...
  const data = await request('https://openrouter.ai/api/v1/chat/completions', {
    method: 'POST',
    headers: { authorization: `Bearer ${key}`, 'content-type': 'application/json', 'HTTP-Referer': process.env.APP_URL || 'https://enjaz-eight.vercel.app', 'X-Title': 'Enjaz AI Workforce' },
