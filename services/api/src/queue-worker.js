...
async function dispatch(job){
 ...
 if(job.job_type==='employee.step'){const p=job.payload||{},s=p.step||{};return runEmployeeTask({workspaceId:job.workspace_id,taskId:p.taskId,employeeId:p.employeeId,action:s.action||'data.analyze',input:s.input||{},graphId:p.graphId||null,stepKey:s.id||null});}
