...
create policy workspace_profiles_member_select on public.workspace_profiles for select using (private.is_workspace_member(workspace_id));
create policy task_delegations_member_select on public.task_delegations for select using (private.is_workspace_member(workspace_id));
create policy integration_action_logs_member_select on public.integration_action_logs for select using (private.is_workspace_member(workspace_id));
