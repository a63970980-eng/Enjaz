...
create policy worker_heartbeats_workspace_member on public.worker_heartbeats for select to authenticated using (private.is_workspace_member(workspace_id));
