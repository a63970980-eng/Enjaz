  ...
  root.innerHTML = `
    ...
    <main id="top">
      <section class="public-hero">
        ...
        <div class="workforce-stage enjaz-reveal" aria-label="عرض تفاعلي للقوة العاملة الرقمية"><div class="stage-orbit orbit-one"></div><div class="stage-orbit orbit-two"></div><div class="stage-core"><span class="core-pulse"></span><strong>ENJAZ</strong><small>DIGITAL ORGANIZATION</small></div><div class="employee-panel featured"><span class="status-dot"></span><small>AI RESTAURANT MANAGER</small><strong>تحليل أداء الفروع</strong><b>94% <i>Performance</i></b></div><div class="employee-panel compact panel-two"><span class="status-dot"></span><small>AI OPERATIONS AGENT</small><strong>48 مهمة نشطة</strong><b>Working</b></div><div class="stage-command"><span>AI COMMAND CENTER</span><strong>من الفكرة إلى النتيجة، تلقائيًا.</strong></div><div class="stage-metrics"><div><b>12</b><span>موظف رقمي</span></div><div><b>94%</b><span>أداء العمليات</span></div><div><b>3</b><span>فروع متصلة</span></div></div></div>
      </section>
