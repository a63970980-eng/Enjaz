...
export const authClient={
  ...
  async signUp(email,password,name){const data=await authRequest('signup',{email,password,data:{full_name:name}});if(data.access_token){sessionStorage.setItem(key,data.access_token);if(data.refresh_token)sessionStorage.setItem(refreshKey,data.refresh_token);}return data;},
