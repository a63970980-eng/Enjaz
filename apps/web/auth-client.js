...
export const authClient={
  ...
  async me(apiBase){
    ...
    // Workspace selection is a client concern. Do not send a stale workspaceId
    // while discovering the user's memberships; this was causing a hard 400 on
    // sessions whose previous workspace had been removed or was not yet stored.
    let r=await fetch(`${apiBase}/api/v1/auth/me`,{headers:{Authorization:`Bearer ${token}`}});
