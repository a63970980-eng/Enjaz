(()=>{
  ...
  const publishableKey=localStorage.getItem('ENJAZ_SUPABASE_ANON_KEY')||keyDefault;
  window.ENJAZ_SUPABASE_KEY=publishableKey;
  window.ENJAZ_SUPABASE_ANON_KEY=publishableKey;
